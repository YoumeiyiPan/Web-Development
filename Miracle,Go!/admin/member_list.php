...
<title> Miracle,Go!-backend-Member List</title>
...
<?php include_once 'menu.php';?>
 ...
 <div class= "col-xs-12">
   ...
   <a href="member_add.php" class="btn btn-primary">Add new member </a>
 </div>
</div>
<div class ="row">
  <div class="col-xs-12">
...
<?php if(!empty($datas)):?>
  <?php foreach($datas as $a_datas):?>
     <tr>
        <td><?php echo $a_datas['id'];?></td>
       <td><?php echo $a_datas['username'];?></td>
       <td> <?php echo $a_datas['email'];?></td>
       <td> 
          <a href="member_edit.php?i=<?php echo $a_datas['id'];?>" class="btn btn-success"> Edit</a>
          <a href="javascript:void(0);" class="btn btn-danger del_member" data-id="<?php echo $a_datas['id'];?>">Delete</a>
