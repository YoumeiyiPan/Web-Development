...
<title> Miracle,Go!-backend-Member Edit</title>
...
<input type = "hidden" id="id" value = "<?php echo $datas['id'];?>">
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" name= "username" id="username" placeholder="Please enter your username" required value ="<?php echo $datas['username'];?>">
    </div>
  </div>
 ...
 <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="email" class="form-control" name= "email" id="email" placeholder="Please enter your email address" required value ="<?php echo $datas['email'];?>">
    </div>
  </div>
...
<script>
  ...
  $("#register_form").on("submit", function(){
        ...
        $.ajax({
          ...
          if(data == "yes")
          {
              alert("Successfully update, enter OK to change into MEMBER LIST page!");
              window.location.href="member_list.php";

          }
          else
          {
            alert("Updating fails!");
