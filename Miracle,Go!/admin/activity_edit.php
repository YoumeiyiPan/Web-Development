...
<title> Miracle,Go!-backend-Activity Edit</title>
...
<script>
  $(document).ready(function(){
    ...
    //$("div.show_mage").html('<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i>');
...
if($("#intro").val()==''){
   ...
   $.ajax({
          ...
          if(data == "yes")
          {
              alert("Update successfully! Click to retrun to Activicity List page.");
